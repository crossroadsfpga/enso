...
source [file join $script_dir esram_altera_iopll_1930_rnqonzq_parameters.tcl]
...
# ----------------------------------------------------------------
    ...
    if {$msg_type == "debug"} {
        if {$::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename_debug} {
            puts $msg
        }
    } else {
        if {$msg_context == "all"} {
...
# ----------------------------------------------------------------
	...
	global ::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename

	ai_post_message info "Initializing PLL database for CORE $::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename"
	set instance_list [ai_get_core_instance_list $::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename]

	foreach instname $instance_list {
		ai_post_message info "Finding port-to-pin mapping for CORE: $::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename INSTANCE: $instname"
...
# ----------------------------------------------------------------
    ...
    set base_clock_data_dict $::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_base_clock_data
    set gen_clock_data_dict $::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_gen_clock_data
