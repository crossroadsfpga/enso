...
#    * The helper routines are defined in esram_altera_iopll_1930_rnqonzq_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/esram_altera_iopll_1930_rnqonzq_parameters.tcl"
source "$script_dir/esram_altera_iopll_1930_rnqonzq_pin_map.tcl"
...
if {[info exists ::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename_ai_pll_db]} {
    # Clean-up stale content
    unset ::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename_ai_pll_db
}
if {[catch {ai_initialize_pll_db ::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename_ai_pll_db} err_initializing_db]} {
...
# following loop
set instances [ array names ::GLOBAL_top_esram_altera_iopll_1930_rnqonzq_corename_ai_pll_db ]
